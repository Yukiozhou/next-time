  ...
  return <View className='shell'>
    <View className='phone'>
      ...
      {screen === 'relationship' && <View className='screen relationship'>
        ...
        <Button className='pool-entry' aria-label='看看池底' onClick={() => setScreen('pool')}><View className='pool-window' aria-hidden='true'><View className='pool-glimpse' />{commitment?.visibilityState === 'SUNK' && <BrandStar className='pool-window-star' />}</View><Text className='pool-entry-link'>看看池底 →</Text></Button>
