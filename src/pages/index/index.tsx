  ...
  return <View className='shell'>
    <View className='phone'>
      ...
      {screen === 'relationship' && <View className='screen relationship'>
        ...
        <Button className='pool-entry' onClick={() => setScreen('pool')}><View className='pool-glimpse' aria-hidden='true' /><View><Text className='section-label'>池</Text><Text className='pool-entry-copy'>{commitment?.visibilityState === 'SUNK' ? '有一句话正在池底安静着。' : '池里现在很安静。'}</Text></View><Text>看看池底 →</Text></Button>
